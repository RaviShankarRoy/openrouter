...
import { parseSseChunks, type ChatCompletionChunk } from '../../src/lib/api-client.js';
import { renderAssistant } from '../../src/commands/chat.js';
import { pickRenderer } from '../../src/lib/output.js';
