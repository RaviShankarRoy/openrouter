...
//   4. Persist access_token via repository/auth.ts (keychain or encrypted file fallback).
import type { Command } from 'commander';
import { createHash, randomBytes } from 'node:crypto';
import open from 'open';
import { ApiClient } from '../repository/api-client.js';
import { setToken, getCredentialStore } from '../repository/auth.js';
import { loadConfig } from '../repository/config.js';
import { pickRenderer } from './output.js';
import { AuthError, exitWithError } from '../shared/errors.js';
