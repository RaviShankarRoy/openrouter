...
from app.application.routing.config import get_routing_config
from app.application.routing.strategies import StrategyRegistry
from app.core.logging import get_logger

if TYPE_CHECKING:  # pragma: no cover
    from app.infrastructure.grpc.gen.routing.v1 import routing_pb2, routing_pb2_grpc  # noqa: F401

try:
    from app.infrastructure.grpc.gen.routing.v1 import routing_pb2, routing_pb2_grpc  # type: ignore[import-not-found]
