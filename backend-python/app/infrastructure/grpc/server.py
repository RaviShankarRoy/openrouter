...
generated stubs live in `app.infrastructure.grpc.gen.*` and are produced by
...
def _register_servicers(server: Server) -> None:
    ...
    try:
        from app.infrastructure.grpc.auth_servicer import AuthServicer
        from app.infrastructure.grpc.gen.auth.v1 import auth_pb2_grpc  # type: ignore[import-not-found]
    ...
    try:
        from app.infrastructure.grpc.gen.routing.v1 import routing_pb2_grpc  # type: ignore[import-not-found]
        from app.infrastructure.grpc.routing_servicer import RoutingServicer
