...
from app.core.security import generate_api_key, hash_api_key, sha256_lookup, verify_api_key
from app.domain.entities import APIKey, KeyScope
...
class AuthService:
    ...
    async def revoke_key(self, key_id: UUID, reason: str) -> None:
        ...
        # Implemented in Phase 2 via app.infrastructure.events.bus.
