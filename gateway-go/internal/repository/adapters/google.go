...
func (g *Google) NormalizeRequest(modelID string, body []byte, cfg model.ProviderConfig) (UpstreamRequest, error) {
	...
	return UpstreamRequest{
		Path:    "/models/" + stripProviderPrefix(modelID) + ":generateContent",
